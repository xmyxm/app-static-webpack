...
module.exports = {
	...
	plugins: [
		...
		new HtmlWebpackPlugin({
			template: './src/html/aboutapp.html',
			filename: 'aboutapp.html' //可以使用hash命名
			,
			title: 'About this App',
			inject: 'body' //脚本包含到body 也可以写到head里面
			,
			chunks: ['manifest', 'vendors', 'common', 'aboutapp'] //指定当前模板需要打入哪些js模块
			,
			minify: { //启用代码代码压缩
				removeComments: true, //移除注释
	...
	devServer: {
		...
		host: 'local.51ping.com',//'m.51ping.com',
